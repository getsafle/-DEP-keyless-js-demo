...
function App() {
  ...
  const sendTransaction = async () => {
    ...
    const toAddress = '0xba5d4e122fab328f077ea895f2fd9bab6d2c2e76';
    const contractAddress = '0x04b33078Ea1aEf29bf3fB29c6aB7B200C58ea126';
    ...
    const sendValue = w3.utils.toBN(5 * Math.pow(10, 18));
